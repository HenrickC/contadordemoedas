...
#por conta de versionamento, este programa só irá funcionar com o uso do tensorflow 2.9.1 e o keras 2.10.0, por consequencia
#versoes do python a partir da 3.10 nao sao compativeis com ele, então, é recomendável usar o python 3.9 para rodar este programa
...
while True:
    ...
    cv2.putText(img,f"R$ {qtd}", cv2.FONT_HERSHEY_SIMPLEX,1.2,(255,255,255),2)
